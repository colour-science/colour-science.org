...
release of `Colour <https://github.com/colour-science/colour/releases/tag/v0.3.0>`__
is available! Although this is an alpha release, the code is well tested and
covered and should be fairly stable.

.. TEASER_END

You can view the highlights of the project on the `features </features>`__ page.

Please follow the `installation guide </installation-guide>`__ in order to
retrieve the code.

We have a few `Jupyter Notebooks <http://nbviewer.jupyter.org/github/colour-science/colour-notebooks/blob/master/notebooks/colour.ipynb>`__
